...
from .models import LSTMMultiClassifier
...
def fixed_window_cv(
    ...
    """Walk-forward fixed-window CV (ported from `LSTM_2.ipynb`).

    Returns:
      - metrics_df
      - preds_df (out-of-sample predictions over all folds)
      - last_fold_artifacts: model_state + scaler stats + metadata (optional)
    """
