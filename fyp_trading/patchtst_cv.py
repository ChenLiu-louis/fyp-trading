...
def fixed_window_cv_patchtst(
    ...
    """Fixed-window walk-forward CV using a PatchTST-style classifier."""
    ...
    for test_start in range(start_index, n - cfg_pipe.test_size + 1, step):
        ...
        model = PatchTSTMultiClassifier(
            seq_len=X_train_sc.shape[1],
            num_channels=X_train_sc.shape[2],
            cfg=cfg_model,
        )
