...
from .transformer_models import TransformerConfig, TransformerMultiClassifier


def fixed_window_cv_transformer(
    ...
    """Fixed-window walk-forward CV using a Transformer encoder classifier."""
    ...
    for test_start in range(start_index, n - cfg_pipe.test_size + 1, step):
        ...
        model = TransformerMultiClassifier(
        ...
        down_acc = (
            accuracy_score(y_true[mask_pred_down], pred_class[mask_pred_down]) if mask_pred_down.any() else np.nan
        )
